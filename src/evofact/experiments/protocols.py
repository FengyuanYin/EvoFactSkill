from evofact.evaluation.ablations import ALL_ABLATION_ARMS
...
class ExperimentProtocol:
    def __init__(self, manifest_id: str, arm: str):
        ...
        if arm not in ALL_ABLATION_ARMS:
...
def all_protocols(manifest_id: str) -> list[ExperimentProtocol]:
    ...
    return [ExperimentProtocol(manifest_id, x) for x in ALL_ABLATION_ARMS]
